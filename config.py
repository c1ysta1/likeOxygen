...
def ArgumentParsers(
    ...
    parser.add_argument("--data_root", default="./brisbane_water_quality.csv",
                        type=str, help="Root directory where dataset is stored.")

    # 新增目标特征参数
    parser.add_argument("--target_feature", default="Turbidity",
                        type=str, help="Target feature to predict (e.g., Turbidity)")
